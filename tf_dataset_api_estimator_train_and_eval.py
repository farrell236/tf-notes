...
train_spec = tf.estimator.TrainSpec(input_fn=lambda: my_input_fn(training_filenames), max_steps=100,
    hooks=[logging_hook])
eval_spec = tf.estimator.EvalSpec(input_fn=lambda: my_input_fn(validation_filenames), 
    hooks=[logging_hook])
...
# https://github.com/tensorflow/tensorflow/issues/14283
