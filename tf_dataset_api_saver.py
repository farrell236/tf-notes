...
with tf.Session() as sess:
    ...
    for i in range(200000):
        ...
        _, _cost = sess.run([train_op, cost], feed_dict={handle: train_iterator_handle})

        if i % 10 == 0:
            print 'training: ' , 'cost: ' , _cost
        ...
        if i % 100 == 0:
            ...
            for j in range(50):
                _cost = sess.run(cost, feed_dict={handle: validation_iterator_handle})
                print 'val:', j , _cost
